  ...
  return data ? (
    <div className='relative'>
        ...
        <div className='text-center mt-20 text-gray-600'>
          ...
          <p className='inline-block py-1 px-4 rounded-full mb-6 border text-sm border-primary/35 bg-primary/35 font-medium
          text-primary'>
            Harishanan Thevarajah
          </p>
        </div>

        <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
          <img src={data.image} alt="Blog post image" className='rounded-3xl mb-5'/>
          ...
          <div className='max-w-3xl mx-auto'>
              ...
              <form onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
                ...
                placeholder='Comment' className='w-full p-2 border border-gray-300 rounded outline-none'></textarea>
